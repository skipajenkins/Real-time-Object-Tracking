...
trackers ={
   'cart':cv.legacy.TrackerCSRT_create, #high accuracy, slow
   'mosse': cv.legacy.TrackerMOSSE_create, #fast, low accuracy
   'kcf': cv.legacy.TrackerKCF_create,  #moderate accuracy, moderate speed
